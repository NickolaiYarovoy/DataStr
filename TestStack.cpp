...
TEST(TestStack, IncreaseSizeTest)
{
    Stack test(1);
    VeryLong a = 15165131;
    DateTime b = DateTime(2530, 10, 15, 12, 23, 33);
...
TEST(TestStack, AddToPositionTest)
{
    Stack test(4);
    VeryLong a = 15165131;
    DateTime b = DateTime(2530, 10, 15, 12, 23, 33);
...
TEST(TestStack, BadAddToPositionTest)
{
    Stack test(4);
    VeryLong a = 1565130;
...
TEST(TestStack, BadTakeFromPositionTest)
{
    Stack test(4);
